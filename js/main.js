...
function changeLanguage(lang) {
  ...
  try {
    //Elephant Detected In A Month Chart(elfDetectedMonth-chart)
    var ctx = document.getElementById("elfDetectedMonth-chart");
    if (ctx) {
      ctx.height = 150;
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          ...
          datasets: [{
            ...
            data: [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200], // Example data
            backgroundColor: 'transparent',
            ...
            pointBackgroundColor: 'rgba(75, 192, 192, 0.75)',
          }]
        },
        options: {
          responsive: true,
  ...
  try {
    //Elephant Detected In A Week Chart(elfDetectedWeek-chart)
    var ctx = document.getElementById("elfDetectedWeek-chart");
    if (ctx) {
      ctx.height = 150;
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: ["Sep 18", "Sep 25", "Oct 02", "Oct 09", "Oct 16", "Oct 23"],
          datasets: [{
            label: "Elephant Detected",
            data: [110, 302, 400, 590, 500, 333], // Example data
            backgroundColor: 'transparent',
            borderColor: 'rgba(75, 192, 192, 0.75)',
            borderWidth: 3,
            pointStyle: 'circle',
